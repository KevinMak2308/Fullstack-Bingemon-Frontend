...
function SingleSeriesFirstSection() {
    return (
                        ...
                        <Box display="grid" gridGap={{ base: "4", md: "6", lg: "8" }} w={{ base: "80vw", md: "40vw", lg: "40vw" }}>
                            ...
                            <Box display="grid" gridGap={{ base: "4", md: "6", lg: "8" }}>
                                <Flex gridGap={{ base: "2", md: "6", lg: "8" }} justifyContent={"space-between"} fontSize={{ base: "13px", md: "14px", lg: "15px" }} flexWrap='wrap' w={{ base: "80vw", md: "40vw", lg: "40vw" }}>
                                    <HStack spacing='7px'>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24"><path fill="currentColor" d="M18 4v1h-2V4c0-.55-.45-1-1-1H9c-.55 0-1 .45-1 1v1H6V4c0-.55-.45-1-1-1s-1 .45-1 1v16c0 .55.45 1 1 1s1-.45 1-1v-1h2v1c0 .55.45 1 1 1h6c.55 0 1-.45 1-1v-1h2v1c0 .55.45 1 1 1s1-.45 1-1V4c0-.55-.45-1-1-1s-1 .45-1 1zM8 17H6v-2h2v2zm0-4H6v-2h2v2zm0-4H6V7h2v2zm10 8h-2v-2h2v2zm0-4h-2v-2h2v2zm0-4h-2V7h2v2z"/></svg>
                                        <Text fontWeight='500' >  XX seasons</Text>
                                    </HStack>
                                    <HStack spacing='7px'>
                                        ...
                                        <Text fontWeight='500'>  First air date</Text>
                                    </HStack>
                                    <HStack spacing='7px'>
