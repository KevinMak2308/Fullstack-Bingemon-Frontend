    ...
    export default function NavBar() {
        ...
        return (
            <Box bg={bgColor} color={textColor}>
                <Flex py={{ base: '10px', sm: '10px', md: '10px', lg: '10px', xl: '10px', "2xl": '10px' }} w='100%' h='10vh' alignContent={"center"} justifyContent={"center"}>
                    <Center>
                        <Flex w='90vw' alignItems={'center'} alignContent={"center"} justifyContent={"space-between"}>
                            ...
                            <Flex alignItems={'center'} gap={{ base: "2", sm: "2", md: "6", lg:"6", xl:"6", "2xl":"8" }} justifyContent={'space-between'}>
                                <Stack
                                    direction={'row'}
                                    display='flex'
                                    alignItems={'center'}
                                ...
                                {/* Dark/light mode */}
                                <Stack direction={'row'} display='flex' alignItems={'center'} spacing={{ base: "1", sm: "1", md: "2", lg:"2", xl:"2", "2xl":"2" }}>
                                    {/* Login */}
                                    {user ? (
                                        <Box py='4'>
                                            <Menu placement="bottom-end">
                                                ...
                                                >
                                                    <Avatar
                                                        bg="#A61212"
                                                        height={{ base: '20px', sm: '24px', md: '28px', lg: '32px', xl: '36px', '2xl': '40px' }}
                                                        width={{ base: '20px', sm: '24px', md: '28px', lg: '32px', xl: '36px', '2xl': '40px' }}
                                                    />
                                                </MenuButton>
                                                <MenuList bg="#343434" border="#343434" color="#F0F0EE" zIndex="2000" minW='xs'>
                                                    <MenuItem
