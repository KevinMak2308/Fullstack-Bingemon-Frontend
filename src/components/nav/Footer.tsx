...
function Footer() {
    return (
        <Box bg={useColorModeValue('#c1c1c1', '#151412')} color={useColorModeValue('#21201D', '#F0F0EE')} display="grid"
             gap={{base: '75px', sm: '80px', md: '85px', lg: '90px', xl: '95px', "2xl": '100px'}}
             pt={{base: '75px', sm: '80px', md: '85px', lg: '90px', xl: '95px', "2xl": '100px'}} pb="35px">
            <Flex justifyContent="center" alignItems="center"
                  gap={{base: "20px", sm: "30px", md: "40px", lg: "50px", xl: "60px", "2xl": "70px"}}
                  placeItems="center" flexDirection={{base: "column", md: "row", lg: "row"}}>
                {/* Logo */}
                <VStack>
                ...
                {/* Movies */}
                <Flex>
                    <Flex flexDirection='column' gap='10px' placeItems={{
                        base: "center",
                        sm: "center",
                        md: "normal",
                        lg: "normal",
                ...
                <Flex>
                    <Box>
                        <Flex flexDirection='column' gap='10px'
                              placeItems={{base: "center", md: "normal", lg: "normal"}}>
                            <Text className='BodyBold'>
                                Discover series
                            </Text>
                            <Box
            ...
            >
                <Image maxW="100px"
                       src='http://localhost:3000/images/blue_short-8e7b30f73a4020692ccca9c88bafe5dcb6f8a62a4c6bc55cd9ba82bb2cd95f6c.svg'/>
                <Text className='SubheaderXsReg'>This product uses the TMDB API but is not endorsed or certified by
                    TMDB.</Text>
            </Flex>
        </Box>
    )
