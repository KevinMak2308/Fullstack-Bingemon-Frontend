    ...
    return (
        <Box bg={useColorModeValue('#dbdbdb', '#1A1917')} color={useColorModeValue('#21201D', '#F0F0EE')} >
            <Flex py={{ base: '75px', md: '', lg: '90px' }} alignContent={"center"} justifyContent={"center"}>
                <Center>
                    <Box w='60vw'>
                        <Flex justifyContent={{sm:'center'}} gap={{sm:'8', md:'10', lg:'14'}} flexDirection={{sm:'column', md:'row', lg:'row'}} alignItems="center">
                            <Box display="grid" gap="4">
                                <Center>
                                    <label htmlFor="profileImage" style={{ cursor: 'pointer' }}>
                                        <Image
                                            ...
                                            w={{ sm: '20vh', md: '21vh', lg: '22vh' }}
                                            h={{ sm: '20vh', md: '21vh', lg: '22vh' }}
                                            alt='Profile'
                                            style={{
                                ...
                                <Center>
                                    <Button as={Button} bg='#343434' color="#F0F0EE" _hover={{ bg: '#484848' }}
                                            onClick={() => {
                            ...
                            <Box display="grid" gridGap={{ base: "2", md: "3", lg: "4" }}>
                                <Flex justifyContent='space-between' alignItems="center" align="center" h='100%' alignContent='center'>
                                    {isEditing ? (
                                        <>
                                            <InputGroup size="lg" style={{ maxWidth: '400px' }} >
                                                <Input
                                                    ...
                                                    css={{
                                                        border: `1px solid ${isEditing ? '#A61212' : '#fff'}`,
                                                        borderRadius: '5px',
                                                        padding: '15px',
                                                        minHeight: '54px',
                                                        fontSize: '45px',
                                                ...
                                                />
                                                <Center>
                                                    <Flex align="center" ml="2" gap="0.75" h='100%' alignContent='center' justify="center" alignItems="center">
                                                        <svg
                                                            onClick={(e) => {
                                                                e.stopPropagation();
                                                                handleToggleEdit(e);
                                ...
                                <Box display="grid" gridGap={{ base: "4", md: "5", lg: "6" }} >
                                    <Flex gridGap={{ base: "2", md: "6", lg: "8" }} justifyContent={"space-between"} fontSize={{ base: "13px", md: "14px", lg: "15px" }} flexWrap='wrap' w={{ base: "80vw", md: "30vw", lg: "40vw" }}>
                                        <HStack
                                            cursor="pointer"
                                            position="relative"
                                            _before={{
                                        ...
                                        >
                                            <Center gap='2' marginBottom="4px">
                                                ...
                                                <Text fontWeight='500'>Denmark</Text>
                                            </Center>
                                        </HStack>
                                        <HStack
                                            cursor="pointer"
                                        ...
                                        >
                                            <Center gap='2' marginBottom="4px">
                                                ...
                                                <Text fontWeight='500'>123 Friends</Text>
                                            </Center>
                                        </HStack>
                                        <HStack
                                            cursor="pointer"
                                        ...
                                        >
                                            <Center gap='2' marginBottom="4px">
                                                ...
                                                <Text fontWeight='500'>{movies.length} Movies Liked</Text>
                                            </Center>
                                        </HStack>
                                        <HStack
                                            cursor="pointer"
                                        ...
                                        >
                                            <Center gap='2' marginBottom="4px">
                                                ...
                                                <Text fontWeight="500">{series.length} Series Liked</Text>
                                            </Center>
                                        </HStack>
                                    </Flex>
                                    <Flex justifyContent='space-between' alignItems="center" align="center" w='100%' h='100%' alignContent='center'>
                                        {isEditingBio ? (
                                            <>
                                                <Flex gap="2">
                                                    <Box style={{ maxWidth: '475px' }}>
                                                        <Textarea
                                                            ...
                                                            css={{
                                                                border: `1px solid ${isEditingBio ? '#A61212' : '#fff'}`,
                                                                borderRadius: '5px',
                                                                padding: '10px',
                                                                minHeight: '75px',
                                                                fontSize: "18px",
