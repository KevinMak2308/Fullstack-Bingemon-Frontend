...
import {Movie, Series, User} from "../../pages/ProfileLiked";
                        ...
                        <SimpleGrid columns={[2, 3, 3, 4, 5, 6]}
                            ...
                            {data[selectedBox].map((data, index) => (
                                <Link key={data.id}
                                    ...
                                    <GridItem key={data.id} w='100%' h='100%' display="grid" gap={{
                                        base: "4px",
                                        sm: "5px",
                                        md: "6px",
                                        lg: "7px",
                                        ...
                                        >
                                            {isClicked ? (
                                                <svg key={`clicked-${data.id}`} xmlns="http://www.w3.org/2000/svg"
                                                ...
                                                <svg key={`hovered-${data.id}`} xmlns="http://www.w3.org/2000/svg"
                                                     width="100%" height="100%" viewBox="0 0 256 256">
                                                    <path fill="#c01515"
                                                ...
                                                <svg key={`default-${data.id}`} xmlns="http://www.w3.org/2000/svg"
                                                     width="100%" height="100%" viewBox="0 0 256 256">
                                                    <path fill="#c01515"
