                    ...
                    <Center>
                        ...
                        >
                            ...
                            <Box display="grid" gridGap={{ base: "4", md: "6", lg: "8" }} >
                                <Flex gridGap={{ base: "2", md: "6", lg: "8" }} justifyContent={"space-between"} alignItems='center' fontSize={{ base: "13px", md: "14px", lg: "15px" }} flexWrap='wrap' w={{ base: "80vw", md: "30vw", lg: "30vw" }}>
