                            ...
                            <Box display="grid" gridGap={{ base: "4", md: "6", lg: "8" }} >
                                <Flex gridGap={{ base: "2", md: "6", lg: "8" }} justifyContent={"space-between"} fontSize={{ base: "13px", md: "14px", lg: "15px" }} flexWrap='wrap' w={{ base: "80vw", md: "40vw", lg: "40vw" }}>
                                    <HStack spacing='7px'>
                                        ...
                                        <Text fontWeight='500'>{movieData.runtime} m.</Text>
                                    </HStack>
                                    <HStack spacing='7px'>
                                        ...
                                        <Text fontWeight='500' >{movieData.release_date}</Text>
                                    </HStack>
                                    {movieData.spoken_languages.map((language) => (
                                        <HStack spacing='7px' key={language.id}>
                                    ...
                                    <HStack spacing='7px'>
                                        ...
                                        <Text fontWeight='500'>{movieData.vote_average}</Text>
                                    </HStack>
                                </Flex>
                                <Flex>
