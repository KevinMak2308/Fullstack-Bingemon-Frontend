...
import '../../App.css';
import {Box, Center, Flex, GridItem, Image, SimpleGrid, Stack, Text, useColorModeValue} from '@chakra-ui/react';
                ...
                <Center>
                    <Box w="80vw">
                        <SimpleGrid display="grid"
                                    gap={{base: "30px", sm: "35px", md: "40px", lg: "45px", xl: "50px", "2xl": "55px"}}
                                    columns={[1, 1, 2, 2, 2, 2]}>
                            {/* Image */}
                            <GridItem>
                                    ...
                                    <Center>
                                        <Stack gap={{
                                            ...
                                            <Text className='SubheaderMdReg'>
                                                With our app, you can swipe through a vast array of movies to discover
                                                the ideal film for your next enjoyable evening.

                                                How does it work? It's simple. By swiping right to 'like' a movie and
                                                left to 'dislike' it, the app begins to learn your preferences. But
                                                that's not where it ends. What truly makes our app unique is the ability
                                                to match movies with your friends.
                                            </Text>
                                            <Box mt={{
                                                base: '15px',
                                                sm: '15px',
